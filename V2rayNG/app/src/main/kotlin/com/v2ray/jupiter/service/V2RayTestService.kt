...
import com.v2ray.jupiter.AppConfig.MSG_MEASURE_CONFIG
import com.v2ray.jupiter.AppConfig.MSG_MEASURE_CONFIG_CANCEL
import com.v2ray.jupiter.AppConfig.MSG_MEASURE_CONFIG_SUCCESS
import com.v2ray.jupiter.util.MessageUtil
import com.v2ray.jupiter.util.SpeedtestUtil
        ...
        when (intent?.getIntExtra("key", 0)) {
            MSG_MEASURE_CONFIG -> {
                ...
                realTestScope.launch {
                    Log.d("config healthy", contentPair.second)
