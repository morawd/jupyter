package com.v2ray.jupiter.viewmodel
...
import com.v2ray.jupiter.databinding.DialogConfigFilterBinding
import com.v2ray.jupiter.AngApplication
...
import com.v2ray.jupiter.util.MmkvManager.KEY_ANG_CONFIGS
...
class MainViewModel(application: Application) : AndroidViewModel(application) {
    ...
    fun appendCustomConfigServer(server: String) {
        ...
        Log.d("Configggg34546733", config.toString())
    ...
    fun updateCache() {
        ...
        for (guid in serverList) {
            ...
            if (keywordFilter.isEmpty() || config.remarks.contains(keywordFilter)) {
                Log.d("config 2213123", config.toString())
    ...
    fun testAllRealPing() {
        ...
        viewModelScope.launch(Dispatchers.Default) { // without Dispatchers.Default viewModelScope will launch in main thread
            for (item in serversCopy) {
                Log.d("config result222", item.toString())
